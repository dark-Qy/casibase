...
import {CloseOutlined, CopyOutlined, ExperimentOutlined} from "@ant-design/icons";
...
class ApplicationViewPage extends React.Component {
  ...
  copyEventDetails = (event) => {
    const details = [
      ...
      `${i18next.t("system:Count")}: ${event.count}`,
        ...
        title={
          <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
            <span>
              ...
              {i18next.t("general:Application Analysis")}
            </span>
            <Button
              size="small"
              icon={<CloseOutlined />}
      ...
      >
        <div style={{height: "500px", border: "1px solid #d9d9d9", borderRadius: "6px", overflow: "hidden"}}>
          <iframe
            ...
            title="Application Analysis Chat"
          />
        </div>
      </Card>
    );
    ...
    return (
      <Card size="small" title={
        <span style={{display: "flex", justifyContent: "space-between", alignItems: "center"}}>
          ...
          <Button type="primary" size="small" onClick={this.analyzeApplication} disabled={!details.events || details.events.length === 0}>
            {i18next.t("general:Analyze")}
          </Button>
        </span>
      } style={{marginBottom: 16}}>
        <Table dataSource={details.events}
          columns={columns}
          pagination={{
            pageSize: 10,
